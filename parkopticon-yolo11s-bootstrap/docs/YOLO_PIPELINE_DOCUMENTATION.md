...
│   └── boxes_autogen.jsonl     # Auto-generated bounding boxes
├── lists/                      # Processing lists
...
**Script:** `labeler/app.py` (FastAPI backend)
...
| `make labeler` | `labeler/app.py` | Launch labeling UI |
