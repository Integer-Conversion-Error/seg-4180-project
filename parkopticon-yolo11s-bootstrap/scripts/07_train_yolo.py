...
def main():
    ...
    parser.add_argument("--batch", "-b", type=int, default=None, help="Batch size (auto if None)")
    parser.add_argument("--device", "-d", default="cpu", help="Device (cpu, 0, etc)")
    parser.add_argument("--name", "-n", default="parkopticon_vehicle_enforcement", help="Run name")
